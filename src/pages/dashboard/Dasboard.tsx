...
import ErrorBoundaryComponent from "../../components/organisms/ErrorBoundaryComponent";

/*
without error boundaries
- cause blank page when render wrong syntax in react
- bad UX/UI
- user can't action anything in app

with error boundaries
- show better UI/UX friendly
- user can't action other section in app
*/
        ...
        <div className="col-span-12 space-y-6 xl:col-span-7">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
              ...
              <div className="flex items-end justify-between mt-5">
                <div>
                  <span className="text-sm text-gray-500 dark:text-gray-400">Resume</span>
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">Average Resume Monthly</h3>
            </div>
            <div className="max-w-full custom-scrollbar">
              <div className="-ml-5 min-w-[650px] xl:min-w-full pl-2">
                {/* demo access control role user */}
                <AccessControl resource="/dashboard/action/create">
                  <Button>Demo access control</Button>
                </AccessControl>
                <br />
                <Button onClick={getUser}>Demo Error Boundary</Button>
                 <br />
